...
<h1 className='font-bold text-center text-3xl'>iTask - Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button
            ...
            className="bg-slate-700 disabled:bg-slate-400 hover:bg-slate-950 p-4 py-2 text-sm font-bold text-white rounded-md mx-6"
          >
            Save
          </button>
        </div>
              ...
              >
                ...
                <div className="buttons flex h-full">
                  <button
                    ...
                    className="bg-slate-700 hover:bg-slate-950 p-3 py-1 text-sm font-bold text-white rounded-md mx-1"
                  >
                    <FaRegEdit />
                  </button>
                  <button
